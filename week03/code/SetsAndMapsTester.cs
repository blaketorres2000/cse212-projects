...
public static class SetsAndMapsTester
{
    public static void Run()
    {
        ...
        Console.WriteLine("---------");
        DisplayPairs(
            new[] { "23", "84", "49", "13", "32", "46", "91", "99", "94", "31", "57", "14" }
        );
        // 32 & 23
        // 94 & 49
        // 31 & 13
    ...
    //************************************************************************
    // ****************  Display Pairs Code For Problem 1 ****************
    //************************************************************************

    private static void DisplayPairs(string[] strings)
    {
    ...
    //************************************************************************
    // ****************  Degree Dictionary Code For Problem 2 ****************
    //************************************************************************
    ...
    //************************************************************************
    // ****************  Is It An Anagram Code For Problem 3 ****************
    //************************************************************************

    private static bool IsAnagram(string word1, string word2)
    {
        // Convert strings to lowercase and remove spaces and special characters
        ...
        char[] sorted1 = cleanWord1.ToCharArray();
        Array.Sort(sorted1);
        char[] sorted2 = cleanWord2.ToCharArray();
        Array.Sort(sorted2);

        // Compare sorted strings
        return new string(sorted1) == new string(sorted2);
    }

    //************************************************************************
    // ****************  Maze Code For Problem 4 *****************************
    //************************************************************************
    ...
    {
        Dictionary<ValueTuple<int, int>, bool[]> map =
            new()
            {
    ...
    private static void EarthquakeDailySummary()
    {
        try
        {
            ...
            Console.WriteLine($"JSON Response: {json}"); // Log the JSON response for debugging
